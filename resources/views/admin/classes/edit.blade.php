<x-app-layout>
    <div class="max-w-lg space-y-5">
        <div class="flex items-center space-x-3">
            ...
            <h1 class="text-2xl font-bold text-slate-800">Sửa lớp học</h1>
        </div>
            ...
            <form method="POST" action="{{ route('admin.classes.update', $class) }}" class="space-y-4">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="date" name="start_time" value="{{ old('start_time', $class->start_time?->format('Y-m-d')) }}"
                    ...
                    <div>
                        ...
                        <input type="date" name="end_time" value="{{ old('end_time', $class->end_time?->format('Y-m-d')) }}"
